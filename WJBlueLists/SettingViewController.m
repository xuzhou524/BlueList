...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString * switchOn = [[NSUserDefaults standardUserDefaults] objectForKey:@"com.xuzhou.WJBlueLists"];
...
-(void)didSwitch{
    NSString * switchOn = [[NSUserDefaults standardUserDefaults] objectForKey:@"com.xuzhou.WJBlueLists"];
    if ([switchOn intValue] == 1) {
        [[NSUserDefaults standardUserDefaults] setValue:@"0" forKey:@"com.xuzhou.WJBlueLists"];
    }else{
        [[NSUserDefaults standardUserDefaults] setValue:@"1" forKey:@"com.xuzhou.WJBlueLists"];
    }
}
