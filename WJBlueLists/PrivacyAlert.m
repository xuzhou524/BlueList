...
//    textView.selectable = NO;
    ...
    NSMutableAttributedString *messageText = [[NSMutableAttributedString alloc] initWithString:@"感谢您使用【蓝牙通】，为了让您更加放心地使用本产品，请您务必仔细阅读，充分理解政策中的条款内容后再点击同意,以便您能够更好地行使个人权利和保护个人信息。\n请您注意，如果您不同意其中任何条款约定，您可以点击不同意，暂停使用本产品。如果您点击同意即表示您已阅读和同意《隐私政策》。"];
